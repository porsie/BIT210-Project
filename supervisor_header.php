                ...
                <div class="col-md-3 bg-secondary sticky-top">
                    <nav>
                        <div class="row row-cols-5 row-cols-md-1">
                            ...
                            <div class="col py-3 text-center text-md-left"><a href="ViewFWAAnalytics.php">View FWA Analytics</a></div>
                            <div class="col py-3 text-center text-md-left"><a href="ReviewFWARequest.php">Review FWA Request</a></div>
                            <div class="col py-3 text-center text-md-left"><a href="#">Review Employee</a></div>
